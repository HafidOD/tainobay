    ...
    <div class="side-widget to-left invert-color mix-blend-difference d-only-desktop">
        <div class="item">
            <span class="widget label-icons">
                <a href="https://www.facebook.com/TainobayPuertoPlata/" class="link black black-hover"
                    target="_blank"><i class="icon fab fa-facebook-f"></i></a>
                <a href="https://www.instagram.com/tainobay_puertoplata/" class="link black black-hover"
                    target="_blank"><i class="icon fab fa-instagram"></i></a>
